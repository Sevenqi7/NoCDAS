// Description: GeGLU leaf for the MFU ALU.  NONLINEAR_IMPL_DPI keeps the
//              optional DPI-C path; the default path uses a local Q4.4 GELU LUT.

module mfu_alu_geglu #(
...
`ifdef NONLINEAR_IMPL_DPI
  import "DPI-C" function int dpi_geglu(input int gate_q, input int up_q);
`endif
...
`ifdef NONLINEAR_IMPL_DPI
        lane_dpi_result_d[issue_lane_idx] = dpi_geglu(
...
`else
    case (lane_gate_byte)
          ...
          8'h07: lane_lut_d[issue_lane_idx] = 8'sd5;
          8'h08: lane_lut_d[issue_lane_idx] = 8'sd6;
          8'h09: lane_lut_d[issue_lane_idx] = 8'sd6;
          8'h0a: lane_lut_d[issue_lane_idx] = 8'sd7;
          8'h0b: lane_lut_d[issue_lane_idx] = 8'sd8;
          8'h0c: lane_lut_d[issue_lane_idx] = 8'sd9;
          8'h0d: lane_lut_d[issue_lane_idx] = 8'sd10;
          8'h0e: lane_lut_d[issue_lane_idx] = 8'sd11;
          8'h0f: lane_lut_d[issue_lane_idx] = 8'sd12;
          8'h10: lane_lut_d[issue_lane_idx] = 8'sd13;
          8'h11: lane_lut_d[issue_lane_idx] = 8'sd15;
          8'h12: lane_lut_d[issue_lane_idx] = 8'sd16;
          8'h13: lane_lut_d[issue_lane_idx] = 8'sd17;
          8'h14: lane_lut_d[issue_lane_idx] = 8'sd18;
          8'h15: lane_lut_d[issue_lane_idx] = 8'sd19;
          8'h16: lane_lut_d[issue_lane_idx] = 8'sd20;
          8'h17: lane_lut_d[issue_lane_idx] = 8'sd21;
          8'h18: lane_lut_d[issue_lane_idx] = 8'sd22;
          8'h19: lane_lut_d[issue_lane_idx] = 8'sd24;
          8'h1a: lane_lut_d[issue_lane_idx] = 8'sd25;
          8'h1b: lane_lut_d[issue_lane_idx] = 8'sd26;
          8'h1c: lane_lut_d[issue_lane_idx] = 8'sd27;
          8'h1d: lane_lut_d[issue_lane_idx] = 8'sd28;
          8'h1e: lane_lut_d[issue_lane_idx] = 8'sd29;
          8'h1f: lane_lut_d[issue_lane_idx] = 8'sd30;
          8'h20: lane_lut_d[issue_lane_idx] = 8'sd31;
          8'h21: lane_lut_d[issue_lane_idx] = 8'sd32;
          8'h22: lane_lut_d[issue_lane_idx] = 8'sd33;
          8'h23: lane_lut_d[issue_lane_idx] = 8'sd34;
          8'h24: lane_lut_d[issue_lane_idx] = 8'sd36;
          8'h25: lane_lut_d[issue_lane_idx] = 8'sd37;
          8'h26: lane_lut_d[issue_lane_idx] = 8'sd38;
          8'h27: lane_lut_d[issue_lane_idx] = 8'sd39;
          8'h28: lane_lut_d[issue_lane_idx] = 8'sd40;
          8'h29: lane_lut_d[issue_lane_idx] = 8'sd41;
          8'h2a: lane_lut_d[issue_lane_idx] = 8'sd42;
          8'h2b: lane_lut_d[issue_lane_idx] = 8'sd43;
          8'h2c: lane_lut_d[issue_lane_idx] = 8'sd44;
          8'h2d: lane_lut_d[issue_lane_idx] = 8'sd45;
          8'h2e: lane_lut_d[issue_lane_idx] = 8'sd46;
          8'h2f: lane_lut_d[issue_lane_idx] = 8'sd47;
          8'h30: lane_lut_d[issue_lane_idx] = 8'sd48;
          8'h31: lane_lut_d[issue_lane_idx] = 8'sd49;
          8'h32: lane_lut_d[issue_lane_idx] = 8'sd50;
          8'h33: lane_lut_d[issue_lane_idx] = 8'sd51;
          8'h34: lane_lut_d[issue_lane_idx] = 8'sd52;
          8'h35: lane_lut_d[issue_lane_idx] = 8'sd53;
          8'h36: lane_lut_d[issue_lane_idx] = 8'sd54;
          8'h37: lane_lut_d[issue_lane_idx] = 8'sd55;
          8'h38: lane_lut_d[issue_lane_idx] = 8'sd56;
          8'h39: lane_lut_d[issue_lane_idx] = 8'sd57;
          8'h3a: lane_lut_d[issue_lane_idx] = 8'sd58;
          8'h3b: lane_lut_d[issue_lane_idx] = 8'sd59;
          8'h3c: lane_lut_d[issue_lane_idx] = 8'sd60;
          8'h3d: lane_lut_d[issue_lane_idx] = 8'sd61;
          8'h3e: lane_lut_d[issue_lane_idx] = 8'sd62;
          8'h3f: lane_lut_d[issue_lane_idx] = 8'sd63;
          8'h40: lane_lut_d[issue_lane_idx] = 8'sd64;
          8'h41: lane_lut_d[issue_lane_idx] = 8'sd65;
          8'h42: lane_lut_d[issue_lane_idx] = 8'sd66;
          8'h43: lane_lut_d[issue_lane_idx] = 8'sd67;
          8'h44: lane_lut_d[issue_lane_idx] = 8'sd68;
          8'h45: lane_lut_d[issue_lane_idx] = 8'sd69;
          8'h46: lane_lut_d[issue_lane_idx] = 8'sd70;
          8'h47: lane_lut_d[issue_lane_idx] = 8'sd71;
          8'h48: lane_lut_d[issue_lane_idx] = 8'sd72;
          8'h49: lane_lut_d[issue_lane_idx] = 8'sd73;
          8'h4a: lane_lut_d[issue_lane_idx] = 8'sd74;
          8'h4b: lane_lut_d[issue_lane_idx] = 8'sd75;
          8'h4c: lane_lut_d[issue_lane_idx] = 8'sd76;
          8'h4d: lane_lut_d[issue_lane_idx] = 8'sd77;
          8'h4e: lane_lut_d[issue_lane_idx] = 8'sd78;
          8'h4f: lane_lut_d[issue_lane_idx] = 8'sd79;
          8'h50: lane_lut_d[issue_lane_idx] = 8'sd80;
          8'h51: lane_lut_d[issue_lane_idx] = 8'sd81;
          ...
          8'haf: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hb0: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hb1: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hb2: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hb3: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hb4: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hb5: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hb6: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hb7: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hb8: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hb9: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hba: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hbb: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hbc: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hbd: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hbe: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hbf: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hc0: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hc1: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hc2: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hc3: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hc4: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hc5: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hc6: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hc7: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hc8: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hc9: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hca: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hcb: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hcc: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hcd: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hce: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hcf: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hd0: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hd1: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hd2: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hd3: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hd4: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hd5: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hd6: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hd7: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hd8: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hd9: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hda: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hdb: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hdc: lane_lut_d[issue_lane_idx] = 8'sd0;
          8'hdd: lane_lut_d[issue_lane_idx] = -8'sd1;
          8'hde: lane_lut_d[issue_lane_idx] = -8'sd1;
          8'hdf: lane_lut_d[issue_lane_idx] = -8'sd1;
          8'he0: lane_lut_d[issue_lane_idx] = -8'sd1;
          8'he1: lane_lut_d[issue_lane_idx] = -8'sd1;
          8'he2: lane_lut_d[issue_lane_idx] = -8'sd1;
          8'he3: lane_lut_d[issue_lane_idx] = -8'sd1;
          8'he4: lane_lut_d[issue_lane_idx] = -8'sd1;
          8'he5: lane_lut_d[issue_lane_idx] = -8'sd1;
          8'he6: lane_lut_d[issue_lane_idx] = -8'sd1;
          8'he7: lane_lut_d[issue_lane_idx] = -8'sd1;
          8'he8: lane_lut_d[issue_lane_idx] = -8'sd2;
          8'he9: lane_lut_d[issue_lane_idx] = -8'sd2;
          8'hea: lane_lut_d[issue_lane_idx] = -8'sd2;
          8'heb: lane_lut_d[issue_lane_idx] = -8'sd2;
          8'hec: lane_lut_d[issue_lane_idx] = -8'sd2;
          8'hed: lane_lut_d[issue_lane_idx] = -8'sd2;
          8'hee: lane_lut_d[issue_lane_idx] = -8'sd2;
          8'hef: lane_lut_d[issue_lane_idx] = -8'sd2;
          8'hf0: lane_lut_d[issue_lane_idx] = -8'sd3;
          8'hf1: lane_lut_d[issue_lane_idx] = -8'sd3;
          8'hf2: lane_lut_d[issue_lane_idx] = -8'sd3;
          8'hf3: lane_lut_d[issue_lane_idx] = -8'sd3;
          8'hf4: lane_lut_d[issue_lane_idx] = -8'sd3;
          8'hf5: lane_lut_d[issue_lane_idx] = -8'sd3;
          8'hf6: lane_lut_d[issue_lane_idx] = -8'sd3;
          8'hf7: lane_lut_d[issue_lane_idx] = -8'sd3;
          8'hf8: lane_lut_d[issue_lane_idx] = -8'sd2;
          8'hf9: lane_lut_d[issue_lane_idx] = -8'sd2;
