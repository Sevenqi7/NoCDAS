// Description: Functional Linear leaf for the MFU ALU.
//              Linear currently shares the same scalar multiply/round/saturate
//              behavior as MatMul but stays split so it can become its own RTL
//              pipeline later.

module mfu_alu_linear #(
